...
public class Agenda {
	...
	/**
	 * Construtor. Ao criar o objeto, os registros cadastrados no arquivo são lidos e adicionados à agenda (caso existam)
	 * @throws IOException
	 */
	...
	public List<Contato> listarContatosPorParteNome(String parteNome) {
		...
		// Lista dos contatos existentes atualmente. O método values() retorna os valores do map em forma de uma collection
